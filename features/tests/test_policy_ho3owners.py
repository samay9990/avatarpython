...
@scenario('TestCases\policy_createquot_ho3owners.feature', 'Verify the HO3 Owners fields under policy')
def test_verify_the_ho3_owners_fields_under_policy():
    """Verify the HO3 Owners fields under policy."""

@scenario('TestCases\policy_createquot_ho3owners.feature', 'Verify the HO3 Owners fields under policy without coverage tab')
def test_verify_the_ho3_owners_fields_under_policy():
    """Verify the HO3 Owners fields under policy."""


@scenario('TestCases\policy_createquot_ho3owners.feature', 'Verify the HO3 Owners fields under policy error check without property and coverage tab')
def test_verify_the_ho3_owners_fields_under_policy():
    """Verify the HO3 Owners fields under policy."""
...
@when('User clicks HO3 Homeowners card')
def user_clicks_ho3_homeowners_card():
    """User clicks HO3 Homeowners card."""
    avatarCreatequote.click_ho3_owner()
