...
@scenario('TestCases\policy_createquote_mho.feature', 'Verify the MHO Direct fields under policy')
...
@when('User clicks MHO Direct card')
def user_clicks_mdp_direct_card():
    """User clicks HO3 Homeowners card."""
    avatarCreatequote.click_mho_direct()
