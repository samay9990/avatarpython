...
@scenario('TestCases\policy_createquote_elementho3select.feature', 'Verify the HO3 Element fields under policy')
def test_verify_the_ho3_element_fields_under_policy():
...
@when('User clicks HO3 Elements card')
def user_clicks_ho3element_direct_card():
    """User clicks HO3 Homeowners card."""
    avatarCreatequote.click_elements_ho3()
