...
@scenario('TestCases\policy_createquote_mdp.feature', 'Verify the MDP Direct fields under policy')
def test_verify_the_mdp_fields_under_policy():
...
def user_clicks_mdp_direct_card():
    ...
    avatarCreatequote.click_mdp_direct()
...
def user_selects_personal_liability(personal_liability):
    ...
    avatarCreatequote.select_personal_liability(personal_liability)
