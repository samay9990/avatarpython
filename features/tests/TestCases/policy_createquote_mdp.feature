...
Feature: Avatar Policy Create Quote
  ...
  Scenario Outline: Verify the MDP Direct fields under policy
    ...
    Examples:
      | first_name  |last_name|dob|occupation|house_number|street_name|zip_code|ppc|bceg|year_built|construction_type|dwelling|personal_liability|medical_payments|cvg_limit|non_hurricane|hurricane|
      | test_policy |test_last|07071991|test |122         |florida    |33319   |1  |1  |2014       |Frame            |200000   |$100,000         |$2,000          |$25,000  |$1000 Deductible| 2% Ded|
